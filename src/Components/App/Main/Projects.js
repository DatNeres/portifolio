...
function Projects() {
  return (
    <div>
      ...
      <div className="h-full grid grid-cols-2 py-80 px-40 font-Righteous max-xl:px-14 max-md:px-4 max-md:grid-cols-1 max-md:grid-rows-2 max-md:py-10">
        ...
        <div className="grid col-start-2 content-center max-md:col-start-1 max-md:row-start-2 max-md:mt-10">
          <h1 className="text-5xl text-gray-700 max-2xl:text-4xl max-lg:text-3xl">
      ...
      <div className="h-full grid grid-cols-2 py-20 px-40 font-Righteous max-xl:px-14 max-md:px-4 max-md:grid-cols-1 max-md:grid-rows-2 max-md:py-0">
        <div className="col-start-1 max-md:row-start-2 max-md:mt-10 max-sm:mt-0">
          <h1 className="text-5xl text-gray-700 max-2xl:text-4xl max-lg:text-3xl">
