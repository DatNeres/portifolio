...
import Blog from "./Components/App/Main/Blog";
...
function App() {
  return (
    <body>
      ...
      <main>
        <Introducion />
        <div className="shadow-2xl rounded-3xl text-gray-600 mx-6 -mt-20 bg-white overflow-x-hidden max-md:-mt-40 max-sm:mx-2">
          <AboutMe />
          <Projects />
          <Blog />
        </div>
